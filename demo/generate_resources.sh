...
# Generate files
java -cp ~/.m2/repository/com/mobialia/gwt-android-emu/0.4/gwt-android-emu-0.4.jar android.utils.GenerateResources android.demo $DIR/source_android_project
