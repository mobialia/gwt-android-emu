...
public final class Rect {
	...
	public static Rect unflattenFromString(String str) {
		...
		return new Rect(Integer.parseInt(matcher.group(1)), Integer.parseInt(matcher.group(2)), Integer.parseInt(matcher.group(3)), Integer.parseInt(matcher
				.group(4)));
	}
